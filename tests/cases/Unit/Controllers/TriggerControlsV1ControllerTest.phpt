 ...
 * @testCase
 */
final class TriggerControlsV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/triggerControlsRead.php
	 */
...
$test_case = new TriggerControlsV1ControllerTest();
$test_case->run();
